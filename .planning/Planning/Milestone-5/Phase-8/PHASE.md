# Phase 8 — Throw Stick / Collect Sticks (#14)

> Part of Milestone 5. Done when: stick animations are baked, wired and accepted, tested, design-gate verdict filed under `docs/design-reviews/` and registered in `docs/asset-gallery.md`.
...
## Notes
- Clarify interaction with objects in the overlay (#21).
