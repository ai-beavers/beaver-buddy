# Phase 11 — Meeting/Speech Animation (#18)

> Part of Milestone 5. Done when: meeting/speech animation is baked, wired and accepted, tested, design-gate verdict filed under `docs/design-reviews/` and registered in `docs/asset-gallery.md`.
