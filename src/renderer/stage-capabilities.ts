...
const CAPABILITIES: Record<Stage, StageCapabilities> = {
  baby:       { stage: 'baby',        canGrab: true,  canType: false, roamPace: 0.7 },
  'young-baby': { stage: 'young-baby',  canGrab: false, canType: false, roamPace: 0.85 },
  teen:       { stage: 'teen',        canGrab: false, canType: false, roamPace: 1.0 },
  'older-teen': { stage: 'older-teen',  canGrab: false, canType: false, roamPace: 1.15 },
  adult:      { stage: 'adult',       canGrab: true,  canType: true,  roamPace: 1.25 },
};
